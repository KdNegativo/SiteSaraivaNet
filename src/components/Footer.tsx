...
import { Wifi, Facebook, Instagram, Phone, Mail } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              A melhor internet de Eliseu Martins. Conectando você ao que importa 
              com velocidade, qualidade e atendimento excepcional.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">(86) 99999-9999</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-5 w-5 text-blue-400" />
                <span className="text-gray-300">contato@saraivanet.com</span>
              </div>
            </div>
          </div>
        </div>
