...
const ThemeToggle = () => {
  ...
  if (!mounted) {
    return (
      <Button variant="ghost" size="icon" className="w-10 h-10 md:w-9 md:h-9">
  ...
  return (
    <Button
      ...
      className="w-10 h-10 md:w-9 md:h-9 text-white hover:bg-white/20 transition-colors mr-2 md:mr-0"
    >
