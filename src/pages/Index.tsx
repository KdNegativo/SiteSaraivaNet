...
import { MapPin, Phone, Mail, Clock, Wifi, Star, Users, Shield, Zap, CheckCircle, ArrowRight, Signal, Router, HeartHandshake, Copy } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 py-4 relative z-10">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#inicio" className="text-white hover:text-orange-300 font-medium transition-colors duration-200">
                Início
              </a>
              <a href="#planos" className="text-white hover:text-orange-300 font-medium transition-colors duration-200">
                Planos
              </a>
              <a href="#sobre" className="text-white hover:text-orange-300 font-medium transition-colors duration-200">
                Sobre
              </a>
              <a href="#cobertura" className="text-white hover:text-orange-300 font-medium transition-colors duration-200">
                Cobertura
              </a>
              <a href="#contato" className="text-white hover:text-orange-300 font-medium transition-colors duration-200">
                Contato
              </a>
            </nav>
      ...
      <section id="inicio" className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 dark:from-blue-950 dark:via-blue-900 dark:to-purple-950 text-white py-20 overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=%22100%22 height=%22100%22 viewBox=%220 0 100 100%22 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cpath d=%22M50 50L50 0L100 50L50 100L0 50Z%22 fill=%22%23ffffff%22 fill-opacity=%220.03%22/%3E%3C/svg%3E')] opacity-20" />
      ...
      <section id="planos" className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Plano 1 */}
            <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-blue-500 hover:scale-105 transform">
              <div className="p-6">
              ...
              <div className="p-6 border-t dark:border-gray-700">
                ...
                >
                  {loadingPlan === "Velocidade" ? "Carregando..." : "Contratar"}
                </Button>
              </div>
            </Card>

            {/* Plano 2 */}
            <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-orange-500 hover:scale-105 transform">
              <div className="p-6">
                <div className="text-center mb-4">
              ...
              <div className="p-6 border-t dark:border-gray-700">
                ...
                >
                  {loadingPlan === "Família" ? "Carregando..." : "Contratar"}
                </Button>
              </div>
            </Card>

            {/* Plano 3 */}
            <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-purple-500 hover:scale-105 transform">
              <div className="p-6">
                <div className="text-center mb-4">
              ...
              <div className="p-6 border-t dark:border-gray-700">
                ...
                >
                  {loadingPlan === "Premium" ? "Carregando..." : "Contratar"}
                </Button>
              </div>
            </Card>
          </div>
