  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="planos" className="py-32 px-6 bg-gradient-to-br from-gray-50 via-white to-orange-50 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-red-200/20 rounded-full blur-3xl translate-x-1/3 translate-y-1/3"></div>
        
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center bg-gradient-to-r from-orange-100 to-red-100 text-orange-600 px-6 py-3 rounded-full text-sm font-bold mb-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <p className="text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
              Internet ultrarrápida + app <span className="text-orange-500 font-bold">SaraivaTV Premium</span> totalmente gratuito. 
              Tudo o que sua família precisa em um só plano!
            </p>
            <div className="inline-flex items-center bg-gradient-to-r from-green-500 to-emerald-500 text-white px-8 py-4 rounded-full font-bold shadow-2xl animate-pulse text-lg">
              🎁 Primeiros 3 meses com 50% de desconto!
            </div>
          </div>

          <div className="flex justify-center">
            {/* Enhanced Plan Card */}
            <Card className="relative border-0 shadow-2xl max-w-lg w-full transform hover:scale-105 transition-all duration-500 hover:shadow-orange-500/30 bg-gradient-to-b from-white via-orange-50/30 to-white overflow-hidden">
              {/* Glowing border effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-orange-500 via-red-500 to-orange-500 rounded-3xl opacity-75"></div>
              <div className="absolute inset-[2px] bg-white rounded-3xl"></div>
              
              {/* Popular badge */}
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                <div className="bg-gradient-to-r from-orange-500 via-red-500 to-orange-500 text-white px-8 py-3 rounded-full text-sm font-black shadow-2xl border-4 border-white">
                  ⭐ MAIS POPULAR ⭐
                </div>
              </div>

              <CardContent className="p-12 bg-gradient-to-b from-white via-orange-50/20 to-white relative z-10">
                <div className="text-center mb-10">
                  <div className="w-28 h-28 bg-gradient-to-br from-orange-500 via-red-500 to-orange-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl transform hover:rotate-6 transition-all duration-300">
                    <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center">
                      <Wifi className="w-12 h-12 text-white" />
                    </div>
                  </div>
                  
                  <h3 className="text-3xl font-black text-gray-800 mb-3">Internet + SaraivaTV</h3>
                  <div className="text-6xl font-black text-transparent bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text mb-2">
                    300MB
                  </div>
                  <div className="text-lg text-gray-500 line-through mb-2">De R$ 169,90</div>
                  <div className="text-5xl font-black bg-gradient-to-r from-gray-800 to-orange-600 bg-clip-text text-transparent mb-2">
                    R$ 129,90
                  </div>
                  <div className="text-lg text-gray-600 font-medium">por mês nos primeiros 6 meses</div>
                  <div className="text-sm text-gray-500 mt-2">Depois R$ 149,90/mês</div>
                </div>

                {/* Features with better styling */}
                <div className="space-y-4 mb-10">
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border-l-4 border-green-500 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                    <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0">
                      <CheckCircle className="w-5 h-5 text-white" />
                    </div>
                    <span className="font-bold text-gray-800">Internet 300MB fibra óptica</span>
                  </div>
                  
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl border-l-4 border-orange-500 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                    <div className="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center flex-shrink-0">
                      <Tv className="w-5 h-5 text-white" />
                    </div>
                    <span className="font-bold text-gray-800">App SaraivaTV Premium GRÁTIS</span>
                  </div>
                  
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border-l-4 border-blue-500 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                    <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0">
                      <Zap className="w-5 h-5 text-white" />
                    </div>
                    <span className="font-bold text-gray-800">Velocidade garantida 24h</span>
                  </div>
                  
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl border-l-4 border-purple-500 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                    <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0">
                      <Shield className="w-5 h-5 text-white" />
                    </div>
                    <span className="font-bold text-gray-800">Suporte técnico 24h gratuito</span>
                  </div>
                  
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border-l-4 border-yellow-500 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                    <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center flex-shrink-0">
                      <Heart className="w-5 h-5 text-white" />
                    </div>
                    <span className="font-bold text-gray-800">Instalação gratuita</span>
                  </div>
                </div>

                {/* Call to action buttons */}
                <div className="space-y-4">
                  <Button className="w-full bg-gradient-to-r from-orange-500 via-red-500 to-orange-500 hover:from-orange-600 hover:via-red-600 hover:to-orange-600 text-white font-black py-6 text-xl rounded-2xl shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-orange-500/50 relative overflow-hidden group">
                    <div className="absolute inset-0 bg-gradient-to-r from-white/20 via-transparent to-white/20 transform -skew-x-12 translate-x-full group-hover:translate-x-[-200%] transition-transform duration-700"></div>
                    <span className="relative z-10">🚀 CONTRATAR AGORA →</span>
                  </Button>
                  
                  <Button variant="outline" className="w-full border-2 border-orange-500 text-orange-600 hover:bg-orange-500 hover:text-white font-bold py-4 text-lg rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105">
                    📞 Falar com Atendente
                  </Button>
                </div>
          ...
          <div className="mt-20 text-center">
            <div className="bg-gradient-to-r from-orange-500 via-red-500 to-purple-600 rounded-3xl p-16 text-white relative overflow-hidden shadow-2xl">
              <div className="absolute inset-0 bg-black/10"></div>
              <div className="absolute top-10 right-10 w-32 h-32 bg-white/10 rounded-full blur-xl animate-pulse"></div>
              <div className="absolute bottom-10 left-10 w-24 h-24 bg-orange-300/20 rounded-full blur-xl animate-pulse delay-1000"></div>
              <div className="relative z-10">
                <h3 className="text-4xl font-black mb-6">Por que escolher a SaraivaNet?</h3>
                <div className="grid md:grid-cols-3 gap-8 text-lg">
                  <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                    <Users className="w-12 h-12 mx-auto mb-4 text-orange-200" />
                    <div className="font-bold mb-2">500+ Famílias</div>
                    <div className="text-orange-200 text-sm">Conectadas e satisfeitas</div>
                  </div>
                  <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                    <Zap className="w-12 h-12 mx-auto mb-4 text-orange-200" />
                    <div className="font-bold mb-2">99.9% Uptime</div>
                    <div className="text-orange-200 text-sm">Conexão sempre estável</div>
                  </div>
                  <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                    <Heart className="w-12 h-12 mx-auto mb-4 text-orange-200" />
                    <div className="font-bold mb-2">Empresa Local</div>
                    <div className="text-orange-200 text-sm">Nascida em Eliseu Martins</div>
                  </div>
                </div>
              </div>
            </div>
